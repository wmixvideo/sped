...
public class SC0100DadosContabilista implements SFLinha {
    ...
    public SC0100DadosContabilista setCampo02Nome(String campo02Nome) {
        this.campo02Nome = campo02Nome;
        return this;
    }

    public SC0100DadosContabilista setCampo03Cpf(String campo03Cpf) {
        this.campo03Cpf = campo03Cpf;
        return this;
    }

    public SC0100DadosContabilista setCampo04Crc(String campo04Crc) {
        this.campo04Crc = campo04Crc;
        return this;
    }

    public SC0100DadosContabilista setCampo05Cnpj(String campo05Cnpj) {
        this.campo05Cnpj = campo05Cnpj;
        return this;
    }

    public SC0100DadosContabilista setCampo06Cep(String campo06Cep) {
        this.campo06Cep = campo06Cep;
        return this;
    }

    public SC0100DadosContabilista setCampo07Endereco(String campo07Endereco) {
        this.campo07Endereco = campo07Endereco;
        return this;
    }

    public SC0100DadosContabilista setCampo08Numero(String campo08Numero) {
        this.campo08Numero = campo08Numero;
        return this;
    }

    public SC0100DadosContabilista setCampo09Complemento(String campo09Complemento) {
        this.campo09Complemento = campo09Complemento;
        return this;
    }

    public SC0100DadosContabilista setCampo10Bairro(String campo10Bairro) {
        this.campo10Bairro = campo10Bairro;
        return this;
    }

    public SC0100DadosContabilista setCampo11Telefone(String campo11Telefone) {
        this.campo11Telefone = campo11Telefone;
        return this;
    }

    public SC0100DadosContabilista setCampo12Fax(String campo12Fax) {
        this.campo12Fax = campo12Fax;
        return this;
    }

    public SC0100DadosContabilista setCampo13Email(String campo13Email) {
        this.campo13Email = campo13Email;
        return this;
    }

    public SC0100DadosContabilista setCampo14MunicipioCodigo(String campo14MunicipioCodigo) {
